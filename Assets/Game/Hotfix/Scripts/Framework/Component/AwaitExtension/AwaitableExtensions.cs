...
namespace Game.Hotfix.Framework.Await
{
    public static partial class AwaitableExtensions
    {
        ...
        public static async Task<IDataTable<T>> LoadDataTableAsync<T>(this DataTableComponent dataTableComponent,
            string dataTableName, string dataTableAssetName, object userData = null) where T : IDataRow
        {
#if UNITY_EDITOR
            TipsSubscribeEvent();
#endif
        ...
        public static async Task PreLoadDataTableAsync(this DataTableComponent dataTableComponent,
    string dataTableName, string dataTableAssetName, object userData = null)
        {
#if UNITY_EDITOR
            TipsSubscribeEvent();
#endif
